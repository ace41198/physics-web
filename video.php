<?php include("assets/inc/header.php"); ?>
        ...
        <p>The form of motion in which the waterballoon is throw at Matthews face near the earth surface as it moves along a curved path. The only force that is actually significant is gravity as it forces the balloon down at an accelerated motion.</p>
        ...
        <h2>Force:</h2>
        <p></p>
        <p>Equation: Mass x Acceleration</p>
        </div>
